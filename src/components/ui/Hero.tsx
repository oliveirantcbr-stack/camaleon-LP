      ...
      >
        ...
        >
          <div className="text-center">
            <p className="text-[8px] font-bold text-violet-300 uppercase tracking-widest mb-1">Ver</p>
...
export default function Hero() {
  ...
  // Morph Progress: Circle → Bottom Arc (scroll 0–600)
  const morphProgress = useTransform(virtualScroll, [0, 600], [0, 1]);
  const smoothMorph = useSpring(morphProgress, { stiffness: 40, damping: 20 });

  // Scroll Rotation (shuffle arc) after morph
  ...
  // Content fades in when arc is formed (morphValue > 0.8)
      ...
      <div className="flex h-full w-full flex-col items-center justify-center" style={{ perspective: "1000px" }}>
        ...
        <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2 px-6">
          ...
          <motion.p
            ...
            className="mt-4 text-xs font-bold tracking-[0.2em] text-violet-400 uppercase"
          >
            Role para explorar
          </motion.p>
        </div>

        {/* --- Arc Active Content (fades in when arc is formed) --- */}
        <motion.div
        ...
        >
          {/* Logo badge */}
          <motion.div
            className="mb-4 inline-flex items-center gap-2 rounded-full border border-violet-500/30 bg-violet-500/10 px-4 py-1.5 backdrop-blur-sm"
          >
          ...
          <p className="text-sm md:text-base text-white/60 max-w-md leading-relaxed">
            A revolução da inteligência artificial criativa.{" "}
            <br className="hidden md:block" />
            Crie textos, imagens, vídeos e automatize seu trabalho em um só lugar.
          </p>
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.97 }}
            className="mt-6 inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-violet-600 to-indigo-600 px-6 py-2.5 text-sm font-semibold text-white shadow-lg shadow-violet-500/20 hover:shadow-violet-500/40 transition-shadow pointer-events-auto"
          >
            Começar agora
